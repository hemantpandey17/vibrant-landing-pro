        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {socialLinks.map((link, index) => (
              <div key={index} className="feature-card flex flex-col items-center text-center">
                ...
                <h3 className="font-bold text-brand-dark">{link.name}</h3>
          ...
          <div className="bg-brand-dark text-white rounded-lg p-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-2xl font-bold mb-2">Find All My Links in One Place</h3>
              ...
              <a 
                ...
                className="bg-white text-brand-dark hover:bg-gray-100 font-medium py-3 px-6 rounded-md transition-all duration-200 inline-flex items-center"
              >
